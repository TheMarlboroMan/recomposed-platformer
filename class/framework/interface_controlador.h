...
class Interface_controlador
{
	...
	virtual void preloop(const Input_base& input, float delta)=0;
	virtual void loop(const Input_base& input, float delta)=0;
	virtual void postloop(const Input_base& input, float delta)=0;
