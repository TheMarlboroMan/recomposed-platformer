...
class Localizador:public Herramientas_proyecto::Localizador_base
{
	...
	Herramientas_proyecto::t_cadena const& cadena_no_cargado() {return c_no_cargado;}
	Herramientas_proyecto::t_cadena const& cadena_no_encontrado() {return c_no_encontrado;}
